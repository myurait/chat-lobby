#!/usr/bin/env python3
"""Register or update the ChatLobby knowledge query pipe in Open WebUI."""
...
DEFAULT_PIPE_FILE = ROOT_DIR / "tools" / "openwebui" / "chatlobby_knowledge_query_pipe.py"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Register or update the ChatLobby knowledge query pipe in Open WebUI.")
    ...
    parser.add_argument("--function-id", default="chatlobby_knowledge_query")
    parser.add_argument("--name", default="ChatLobby Knowledge Query")
    parser.add_argument(
        "--description",
        default="Search and read canonical repository knowledge through the local knowledge adapter.",
    )
