#!/usr/bin/env python3
"""Register or update the ChatLobby dispatch pipe in Open WebUI."""
...
DEFAULT_PIPE_FILE = ROOT_DIR / "tools" / "openwebui" / "chatlobby_dispatch_task_pipe.py"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Register or update the ChatLobby dispatch pipe in Open WebUI.")
    ...
    parser.add_argument("--function-id", default="chatlobby_dispatch_task")
    parser.add_argument("--name", default="ChatLobby Dispatch Task")
    parser.add_argument(
        "--description",
        default="Dispatch a task automatically to Claude, Codex, or knowledge based on routing rules.",
    )
