#!/usr/bin/env python3
"""Register or update the ChatLobby Codex task pipe in Open WebUI."""
...
DEFAULT_PIPE_FILE = ROOT_DIR / "tools" / "openwebui" / "chatlobby_codex_task_pipe.py"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Register or update the ChatLobby Codex task pipe in Open WebUI.")
    ...
    parser.add_argument("--function-id", default="chatlobby_codex_task")
    parser.add_argument("--name", default="ChatLobby Codex Task")
    parser.add_argument(
        "--description",
        default="Run a Codex task through the local Codex adapter and return the result to chat.",
    )
